    ...
    <div class="container">
        <form action="post.php" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="Nhập tên snh viên" name="user">
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="radio" id=""name="gender">Nam
                <input type="radio" id=""name="gender">Nữ
            </div>  
            
            <button type="submit" class="btn btn-primary" name="form_click">Login</button>
        </form>
    </div>
</body>
</html>